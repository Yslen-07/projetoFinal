...
<<<<<<< HEAD
  ...
  var title: String {
    switch self {
    case .APEC: return "Bem vindo ao APEC"
    case .Esportes: return "Fique por dentro da SEC"
    case .Teatro: return "Eventos culturais"
    }
  }

  var description: String {
    switch self {
    case .APEC: return "Fique por dentro da semana esportiva e cultural do IFCE campus Fortaleza"
    case .Esportes: return "Descubra como seu curso está indo nos esportes. Pontuação, locais e horários."
    case .Teatro: return "Descubra os eventos que ocorrem durante essa semana incrível e muito mais!"
=======
    case APEC
    case Esportes
    case Teatro
...
<<<<<<< HEAD
    var onFinished: (() -> Void)?  // Closure para avisar que terminou o onboarding
            ...
            Button {
                withAnimation(.spring()) {
                    if currentPage < OnboardingPage.allCases.count - 1 {
                        ...
                        // Chamando a closure para avisar que terminou o onboarding
                        onFinished?()
                    }
                }
            } label: {
...
<<<<<<< HEAD
    // Seu código das animações abaixo (SecImageGroup, SportAnimation, playAnimation)
    // Copie exatamente como no seu código original para manter animações
